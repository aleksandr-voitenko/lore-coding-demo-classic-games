...
- Snake, Tetris, Minesweeper, and 2048 replay saves are profile-scoped. The live
  game components record replay events unconditionally after a server-issued run,
  but `/api/replays/<game>` requires a signed-in session before saving or
