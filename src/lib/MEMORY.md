...
- `snake-replay.ts`, `tetris-replay.ts`, `minesweeper-replay.ts`, and
  ...
  events, Tetris moves, rotations, soft drops, hard drops, Minesweeper reveals
  and flag toggles, and 2048 move directions rather than video or full board
  snapshots.
