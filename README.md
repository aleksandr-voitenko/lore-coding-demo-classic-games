...
- Snake, Tetris, Breakout, Minesweeper, Pong, and 2048 replay recording with
...
Snake, Tetris, Breakout, Minesweeper, Pong, and 2048 record replay events
...
`/?replay=minesweeper`, `/?replay=pong`, or `/?replay=twenty-forty-eight` for
client playback.
